...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    for regime in regimes:
        ...
        for T in horizons:
            ...
            for pol in ("cd_ts", "adaptive_cd_ts", "static_optimal", "round_robin"):
                scaling_rows.append(
        ...
        summary += [
            ...
            f"(R²={sx['cd_ts']['r2']:.3f})   ← sublinear, γ tuned from known V_T",
            f"  adaptive CD-TS (NO V_T) exponent   : {sx['adaptive_cd_ts']['exponent']:.3f} "
            f"(R²={sx['adaptive_cd_ts']['r2']:.3f})   ← sublinear, V_T-free (CUSUM restart)",
